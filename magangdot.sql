...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2019 at 10:43 AM
...
INSERT INTO `calon_magangs` (`id`, `id_posisi`, `kampus`, `nama`, `jurusan`, `telp`, `email`, `instagram`, `facebook`, `cv`, `portofolio`, `tgl_awal`, `tgl_akhir`, `alasan`, `alasan_posisi`, `id_info`, `status`, `created_at`, `updated_at`) VALUES
