...
{
    protected $fillable = ['id_posisi', 'kampus','nama', 'jurusan', 'telp', 'tgl_awal', 'tgl_akhir', 'facebook', 'instagram','email', 'alasan', 'alasan_posisi','id_info', 'cv', 'portofolio','status','flow'];
